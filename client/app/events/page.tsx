...
const pastEventSections = [
  {
    ...
    images: [
      "/events/signature-meetup-2026/1.JPG",
      "/events/signature-meetup-2026/2.JPG",
      "/events/signature-meetup-2026/3.JPG",
      "/events/signature-meetup-2026/4.JPG",
      "/events/signature-meetup-2026/5.JPG",
      "/events/signature-meetup-2026/6.JPG",
      "/events/signature-meetup-2026/7.JPG",
      "/events/signature-meetup-2026/8.JPG",
      "/events/signature-meetup-2026/9.JPG",
      "/events/signature-meetup-2026/10.JPG",
      "/events/signature-meetup-2026/11.JPG",
    ],
  },
  {
          ...
          <div className="mx-auto mt-12 max-w-6xl space-y-5 py-5">
            {pastEventSections.map((section, sectionIndex) => (
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-4 md:grid-flow-dense md:auto-rows-fr md:grid-cols-8 md:grid-rows-4">
